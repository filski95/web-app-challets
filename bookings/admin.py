...
from bookings.models import ChalletHouse, CustomerProfile, Opinion, Reservation, ReservationConfrimation, Suggestion
...
admin.site.register(ReservationConfrimation)
